(function (global, factory) {
  ...
  function updateSlides() {
    ...
    if (params.setWrapperSize) {
      $wrapperEl.css({
        [getDirectionLabel("width")]: `${swiper.virtualSize + params.spaceBetween
          }px`,
      });
    }
    if (gridEnabled) {
  ...
  function updateSlidesClasses() {
    ...
    if (params.loop) {
      if (nextSlide.hasClass(params.slideDuplicateClass)) {
        $wrapperEl
          .children(
            `.${params.slideClass}:not(.${params.slideDuplicateClass
  ...
  function updateActiveIndex(newActiveIndex) {
    ...
    Object.assign(swiper, { snapIndex, realIndex, previousIndex, activeIndex });
  ...
  function Keyboard({ swiper, extendParams, on, emit }) {
    ...
    Object.assign(swiper.keyboard, { enable, disable });
  }
  function Mousewheel({ swiper, extendParams, on, emit }) {
    ...
    Object.assign(swiper.mousewheel, { enable, disable });
  }
  ...
  function Navigation({ swiper, extendParams, on, emit }) {
    ...
    Object.assign(swiper.navigation, { update, init, destroy });
  }
  ...
  function Pagination({ swiper, extendParams, on, emit }) {
    ...
    Object.assign(swiper.pagination, { render, update, init, destroy });
  }
  function Scrollbar({ swiper, extendParams, on, emit }) {
    ...
    swiper.scrollbar = { el: null, dragEl: null, $el: null, $dragEl: null };
    function setTranslate() {
  ...
  function Lazy({ swiper, extendParams, on, emit }) {
    ...
    Object.assign(swiper.lazy, { load, loadInSlide });
  }
  function Controller({ swiper, extendParams, on }) {
    ...
    Object.assign(swiper.controller, { setTranslate, setTransition });
  }
  ...
  function History({ swiper, extendParams, on }) {
    extendParams({
      history: { enabled: false, root: "", replaceState: false, key: "slides" },
    });
  ...
  function Autoplay({ swiper, extendParams, on, emit }) {
    let timeout;
    swiper.autoplay = { running: false, paused: false };
    extendParams({
      autoplay: {
        enabled: false,
        delay: 3000,
    ...
    Object.assign(swiper.autoplay, { pause, run, start, stop });
  }
  function Thumb({ swiper, extendParams, on }) {
    ...
    Object.assign(swiper.thumbs, { init, update });
  }
  ...
  function Grid({ swiper, extendParams }) {
    ...
    swiper.grid = { initSlides, updateSlide, updateWrapperSize };
  }
  function appendSlide(slides) {
    const swiper = this;
  ...
  function EffectFade({ swiper, extendParams, on }) {
    extendParams({ fadeEffect: { crossFade: false, transformEl: null } });
    const setTranslate = () => {
      const { slides } = swiper;
    ...
    const setTranslate = () => {
      ...
      if (params.shadow) {
        if (isHorizontal) {
          ...
          $cubeShadowEl.transform(
            `scale3d(${scale1}, 1, ${scale2}) translate3d(0px, ${swiperHeight / 2 + offset
      ...
      $wrapperEl.transform(
        `translate3d(0px,0,${zFactor}px) rotateX(${swiper.isHorizontal() ? 0 : wrapperRotate
  ...
  function EffectCards({ swiper, extendParams, on }) {
    extendParams({ cardsEffect: { slideShadows: true, transformEl: null } });
    const setTranslate = () => {
